    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-16 h-16 rounded-full bg-brand-tosca/80 backdrop-blur-md flex items-center justify-center shadow-[0_0_30px_rgba(31,75,154,0.6)] group-hover:scale-110 transition-transform">
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-5xl aspect-video bg-black rounded-[2rem] overflow-hidden border border-brand-tosca/30 shadow-[0_0_100px_rgba(31,75,154,0.2)]"
