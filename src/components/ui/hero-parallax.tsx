    ...
    >
      ...
      >
        <div className="w-full text-center pb-16">
          <h2 className="text-3xl md:text-5xl font-light text-neutral-900 dark:text-white tracking-tight">
            Portofolio <span className="font-bold text-brand-tosca">Impact</span>
          </h2>
          <p className="text-neutral-600 dark:text-brand-gray mt-4 max-w-xl mx-auto text-sm md:text-base">
            Pencapaian startup, peluncuran program, dan sorotan ekosistem yang kami bangun bersama.
          </p>
        </div>
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-3xl md:text-7xl font-light dark:text-white text-neutral-900 tracking-tight">
        Bangun Startup. <br /> Perluas Dampak.
      </h1>
      <p className="max-w-2xl text-sm md:text-xl mt-8 dark:text-neutral-200 text-neutral-600 leading-relaxed font-light">
        Ekosistem menyeluruh untuk founder dan institusi: inkubasi, mentoring, dan dukungan eksekusi end-to-end.
      </p>
    </div>
  );
};
